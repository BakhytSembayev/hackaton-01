    ...
    document.addEventListener('click', (e) => {
      if (e.target.closest('[data-action="ok"]')) {
        ...
        if (timeUser > 120 || !timeUser?.match(/^\d+$/) || timeUser == 0) {
          modal.setBody('<div style="display: flex; flex-wrap: nowrap; height: auto; max-width: 100%;"><img src="../src/assets/cub.png" alt="" style="display: block; height: 125px; width: 125px;"><p style="padding-left: 20px;"> Вы задали некорректный интервал времени. Повторите попытку!</p></div>');
          ...
          modal.show();
            ...
            clickedCounter.textContent = 'Количество: ';
          ...
          function onclickCounter (appDiv) {
            if (timeUser > 0) {
              ...
              if (appDiv.pageX + clickPrint.offsetWidth < document.body.offsetWidth) {
                ...
                modal.setBody('<div style="display: flex; flex-wrap: wrap; height: auto; max-width: 100%;"><img src="../src/assets/cub.png" alt="" style="display: block; height: 125px; width: 125px;"><div style="display: flex; flex-direction: column; height: auto; max-width: 100%;"><p style="padding-left: 20px; text-align: center; font-weight: bold;">ОТЛИЧНО!</p><p id="p-modal" style="padding-left: 20px;">...</p></div></div>');
